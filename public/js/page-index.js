...
ListopicApp.pageIndex = (() => {
    ...
    const heroSubtitles = [
        "Donde las listas se hacen famosas y t� tambi�n un poquito.",
        "El Olimpo de las listas absurdamente serias.",
        "Aqu� las listas se sienten importantes.",
        "Donde las listas vienen a ponerse guapas.",
        "Listas que har�an suspirar a una hoja de c�lculo.",
        "Tu peque�o portal para poner orden sin drama.",
        "La biblioteca infinita de tus �depende�.",
        "Ideas sueltas buscando lista.",
        "El pa�s de las listas que siempre tienen sitio para una m�s.",
        "Aqu� las listas salen mejor peinadas.",
        "El universo paralelo donde todo queda clarito.",
        "Territorio apto para mani�ticos y despistados por igual.",
        "El habit�culo premium para tus elecciones m�s raras.",
        "Un refugio para pensamientos con vocaci�n de ranking.",
        "Aqu� tus obsesiones tienen su propio ranking.",
        "Donde lo aleatorio encuentra estructura.",
        "Donde los gustos se alinean� o al menos se saludan.",
        "La rep�blica independiente de tus opiniones.",
        "Donde cada gusto encuentra su casillita.",
        "Tu consola personal para ajustar el mundo.",
        "Si la vida es un l�o, al menos lista tus l�os con estilo.",
        ...
        "La c�psula espacial para tus gustos interplanetarios.",
        "El coliseo honorable de tus opiniones.",
        "El para�so de los que piensan en modo �bullet point�.",
        "Explora, vota� y presume de criterio sin verg�enza.",
        "Listas para gente seria. Y para ti tambi�n.",
        "Tu mapa personal de lo importante� y de lo no tanto.",
        "Un buen lugar para pensar en columnas.",
        "Listopic: m�s ordenado que tu caj�n de cables.",
        "Tu rinc�n para clasificar lo inclasificable.",
        "Aqu� las opiniones encuentran hogar.",
        ...
        "Aqu� las listas vienen a sentirse organizadas.",
        "Listas sin prisa, pero con intenci�n.",
        "Pasa, crea y ord�nalo a tu manera.",
        "La zona segura para tus comparaciones imposibles.",
        "Un rinc�n amable para tus �esto va primero�.",
        "Donde el orden se vuelve un poco m�s simp�tico.",
        "El punto exacto entre caos y criterio.",
        "Aqu� empieza el viaje de tus listas m�s ambiciosas.",
        "Las listas que tu mente estaba intentando hacer desde hace d�as.",
        "El lugar donde tus gustos encuentran la paz (temporal).",
        "Las listas aqu� madrugan solas, nadie sabe por qu�.",
        "El spa favorito de los gustos cansados.",
        "Donde las ideas hacen cola para verse m�s ordenadas.",
        "El balneario oficial de las comparaciones tensas.",
        "Listas que se estiran antes de empezar.",
        "La cafeter�a secreta donde se re�nen los criterios.",
        "El gimnasio donde tus prioridades levantan pesas.",
        "El hotel boutique de tus opiniones m�s viajeras.",
        "Donde los pensamientos vienen a hacerse un retoque.",
        "El pa�s donde los gustos pagan impuestos simb�licos.",
        "El lugar donde tus gustos vienen a aclararse un poco.",
        "Tu espacio para ordenar lo que solo t� entiendes.",
        ...
        "Tus criterios, ahora con luz y taqu�grafos.",
        "El sitio donde tus gustos conversan entre ellos.",
        "El rinc�n donde tus elecciones respiran hondo.",
        "Aqu� el caos se porta un poquito mejor.",
