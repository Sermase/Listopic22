        ...
        <div className="max-w-6xl mx-auto space-y-6">
                ...
                <div className="flex items-center gap-3">
                    <label className="flex items-center gap-2 text-sm text-gray-400 cursor-pointer">
                        <input
                            ...
                            className="w-4 h-4 rounded border-gray-600 text-indigo-600 bg-[#0b1021]"
                        />
                        Mostrar sublistas
                    </label>
                    <button
            ...
            {showCreateModal && (
                <div className="fixed inset-0 z-50 flex items-start justify-center bg-black/70 backdrop-blur-sm overflow-y-auto py-8 px-4" onClick={(e) => { if (e.target === e.currentTarget) setShowCreateModal(false); }}>
                    <div className="w-full max-w-3xl bg-[#0b1021] rounded-2xl border border-white/10 p-6 relative" onClick={e => e.stopPropagation()}>
                        <button
