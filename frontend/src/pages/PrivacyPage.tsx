            ...
            <div className="max-w-3xl mx-auto px-4 sm:px-6 pt-8">
                ...
                <div className="bg-[#151b2e]/60 border border-white/10 rounded-3xl p-6 sm:p-8 mb-6">
                    ...
                    <Section title="7. Conservación de datos">
                        <ul className="list-disc list-inside space-y-1">
                            <li><span className="text-white font-medium">Datos de cuenta y contenido:</span> mientras mantengas tu cuenta activa o hasta que solicites su eliminación.</li>
                            <li><span className="text-white font-medium">Datos técnicos:</span> máximo 14 meses desde su recogida.</li>
                            <li>Tras la eliminación de la cuenta, los datos se borran de forma definitiva en un plazo máximo de 30 días.</li>
                        </ul>
                    </Section>
